...
//      this.setOn(switchAccessory)
  ...
  async setOn () {
    ...
    if (!this.switchOn) {
      ...
      let timeObject = {}
      timeObject.time = dt.toLocaleString(DateTime.TIME_SIMPLE)
      timeObject.date = dt.toLocaleString(DateTime.DATE_MED)
      timeObject.week = dt.toFormat('WW')
      ...
      if (this.pcText) {
        let pcText = stringInject(this.pcText, timeObject)
        this.log('%o, %s', timeObject, pcText)
